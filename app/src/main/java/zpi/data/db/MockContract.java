...
public class MockContract {
    ...
    public static final String InterestingPlaceCreation = "create table " + InterestingPlaceEntry.TABLE_NAME +  "(" + InterestingPlaceEntry.COLUMN_NAME_ID + " integer primary key autoincrement, " + InterestingPlaceEntry.COLUMN_NAME_NAME + " varchar(50) not null, " + InterestingPlaceEntry.COLUMN_NAME_DESC + " varchar(1000) not null, " + InterestingPlaceEntry.COLUMN_NAME_LONG + " double(8) not null, " + InterestingPlaceEntry.COLUMN_NAME_LAT + " double(8) not null);";
    public static final String RestPointCreation = "create table " + RestPointEntry.TABLE_NAME + " (" + RestPointEntry.COLUMN_NAME_ID + " integer primary key autoincrement, " + RestPointEntry.COLUMN_NAME_NAME + " varchar(50) not null, " + RestPointEntry.COLUMN_NAME_DESC + " varchar(1000) not null, " + RestPointEntry.COLUMN_NAME_LONG + " double(8) not null, " + RestPointEntry.COLUMN_NAME_LAT + " double(10) not null, Type integer(10) not null);";
