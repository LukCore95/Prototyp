...
public class MockContract {
    ...
    private static final String InterestingPlaceCreation = "create table " + InterestingPlaceEntry.TABLE_NAME +  "(" + InterestingPlaceEntry.COLUMN_NAME_ID + " integer not null primary key, " + InterestingPlaceEntry.COLUMN_NAME_NAME + " varchar(50) not null, " + InterestingPlaceEntry.COLUMN_NAME_DESC + " varchar(1000) not null, " + InterestingPlaceEntry.COLUMN_NAME_LONG + " double(8) not null, " + InterestingPlaceEntry.COLUMN_NAME_LAT + " double(8) not null);";
    private static final String RestPointCreation = "create table " + RestPointEntry.TABLE_NAME + " (" + RestPointEntry.COLUMN_NAME_ID + " integer not null primary key, " + RestPointEntry.COLUMN_NAME_NAME + " varchar(50) not null, " + RestPointEntry.COLUMN_NAME_DESC + " varchar(1000) not null, " + RestPointEntry.COLUMN_NAME_LONG + " double(8) not null, " + RestPointEntry.COLUMN_NAME_LAT + " double(10) not null, Type integer(10) not null);";
    private static final String RestPointPhotoCreation = "create table " + RestPointPhotoEntry.TABLE_NAME + " (" + RestPointPhotoEntry.COLUMN_NAME_ID + " integer not null primary key, " + RestPointPhotoEntry.COLUMN_NAME_POINT + " integer(10) not null, foreign key(" + RestPointPhotoEntry.COLUMN_NAME_POINT + ") references " + RestPointEntry.TABLE_NAME + "(" + RestPointEntry.COLUMN_NAME_ID + "));";
